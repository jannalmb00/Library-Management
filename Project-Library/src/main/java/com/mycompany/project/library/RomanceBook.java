...
/**
 *  <p>
 *  RomanceBook class is created by the Bookfactory Class, 
 *  and contains the constructor for the RomanceBook class.
 *  </p>
 * @author janna
 * @author raeeba
 */
public class RomanceBook extends Book {
     ...
     /**
     * <p>
     * Constructor for RomanceBook class which inherits from Book superclass
     * </p>
     ...
     */
    public RomanceBook(String SN, String title, String author, String publisher, double price, int quantity, int issuedQuantity, Date dateofPurchase, String genre) {
