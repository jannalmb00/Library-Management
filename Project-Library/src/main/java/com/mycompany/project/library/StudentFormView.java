...
public class StudentFormView extends javax.swing.JFrame {
    ...
    private void englishRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_englishRadioButtonActionPerformed
        ...
        borrowBtnS.setText(bundle.getString("borrowBtn.text"));
    ...
    private void frenchRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_frenchRadioButtonActionPerformed
        ...
        borrowBtnS.setText(bundleFR.getString("borrowBtn.text"));
        returnBtn.setText(bundleFR.getString("returnBtn.text"));
        searchBtn.setText(bundleFR.getString("searchBtn.text"));
        viewCatalogBtn.setText(bundleFR.getString("viewCatalogBtn.text"));
        viewIssuedCatalogBtn.setText(bundleFR.getString("viewIssuedCatalogBtn.text"));
