...
/**
 *  <p>
 *  BiographyBook class is created by the Bookfactory Class, 
 *  and contains the constructor for the BiographyBook class.
 *  </p>
 * @author janna
 * @author raeeba
 */
public class BiographyBook extends Book {
    ...
    /**
     * <p>
     * Constructor for BiographyBook class which inherits from Book superclass
     * </p>
     ...
     */
    public BiographyBook(String SN, String title, String author, String publisher, double price, int quantity, int issuedQuantity, Date dateofPurchase, String genre) {
