...
/**
 *  <p>
 *  FantasyBook class is created by the Bookfactory Class, 
 *  and contains the constructor for the FantasyBook class.
 *  </p>
 * @author janna
 * @author raeeba
 */
public class FantasyBook extends Book {
    ...
    /**
     * <p>
     * Constructor for FantasyBook class which inherits from Book superclass
     * </p>
     ...
     */
    public FantasyBook(String SN, String title, String author, String publisher, double price, int quantity, int issuedQuantity, Date dateofPurchase, String genre) {
